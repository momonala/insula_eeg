//initializations for ekg at line 123
...
class ChannelController {
  ...
  public void update() {
    ...
    for (int i = 0; i < nchan; i++) {
      ...
      //gain
      channelSettingValues[0][1] = '2';
      channelSettingButtons[0][1].setString("x2");
      //bias
      channelSettingValues[0][3] = '0';
      channelSettingButtons[0][3].setString("Don't Include");
      //srb2
      channelSettingValues[0][4] = '0';
      channelSettingButtons[0][4].setString("Off");
  ...
  public void draw() {
    ...
    // printing out the channel settings 
    for(int i = 0; i < 8; i++)
    {
        //println("channel :"+i); 
        for(int j=0; j<5; j++)
        {
          //println(channelSettingValues[i][j]); 
